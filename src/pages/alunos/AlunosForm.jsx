...
import validator from '../../validators/AlunoValidator'
            ...
            <Box title="Alunos">
                <Form>
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="Logradouro">
                        ...
                        <Col sm={10}>
                            <Form.Control type="text" placeholder="Insira seu logradouro..." {...register("Logradouro", {required: true})} />
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="bairro">
                        ...
                        <Col sm={10}>
                            <Form.Control type="text" placeholder="Insira o nome do bairro em que reside..." {...register("bairro", {required: true})} />
